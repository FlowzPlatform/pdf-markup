...
var DEFAULT_URL = './static/js/compressed.tracemonkey-pldi-09.pdf';
// var DEFAULT_URL = 'http://res.cloudinary.com/flowz/raw/upload/v1517405443/flowz-dashboard/Teamwork_Evaluation_-_Project_Report_-_12_July_2017.pdf'
...
PDFJS.imageResourcesPath = '../src/assets/images/';
  PDFJS.workerSrc = '../static/js/pdf.worker.js';
  PDFJS.cMapUrl = '../src/cmaps/';
  ...
  PDFDocumentProperties.prototype = {
    ...
    _getProperties: function PDFDocumentProperties_getProperties() {
      ...
      this.pdfDocument.getMetadata().then(function(data) {
        ...
        console.log('Page count::::', this.pdfDocument.numPages)
